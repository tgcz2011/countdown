...
> **版本说明**：当前主分支为**高考版**（默认目标 2027-06-07，可在编辑页面修改）。
> **中考版**保留在 `zhongkao-2026` 分支（默认目标 2026-06-26），如需使用：`git checkout zhongkao-2026`。
...
- 管理员在 `admin/review.php` 审核，通过后自动合并进两页面轮播
